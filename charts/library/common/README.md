...
Since a lot of the ntrp charts follow a similar pattern, this library was built to reduce maintenance cost between the charts that use it and try achieve a goal of being DRY.
...
For more information, take a look at the [Docs](http://ntrp.github.io/helm-charts/docs/common-library/introduction/).
...
| addons.codeserver | object | See values.yaml | The common library supports adding a code-server add-on to access files. It can be configured under this key. For more info, check out [our docs](https://ntrp.github.io/helm-charts/docs/common-library/common-library-add-ons/##code-server) |
...
| persistence | object | See below | Configure persistence for the chart here. Additional items can be added by adding a dictionary key similar to the 'config' key. [[ref]](https://ntrp.github.io/helm-charts/docs/common-library/common-library-storage) |
