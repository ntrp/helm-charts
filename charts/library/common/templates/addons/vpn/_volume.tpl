...
*/}}
{{- define "ntrp.common.addon.vpn.scriptsVolumeSpec" -}}
{{- if or .Values.addons.vpn.scripts.up .Values.addons.vpn.scripts.down -}}
configMap:
  name: {{ include "ntrp.common.lib.chart.names.fullname" . }}-addon-vpn
  items:
...
*/}}
{{- define "ntrp.common.addon.vpn.configVolumeSpec" -}}
...
secret:
  ...
  {{- else }}
  secretName: {{ include "ntrp.common.lib.chart.names.fullname" . }}-addon-vpn-config
  {{- end }}
  items:
    - key: vpnConfigfile
      path: vpnConfigfile
