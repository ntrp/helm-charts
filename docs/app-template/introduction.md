...
and its [`values.yaml`](https://github.com/ntrp/helm-charts/tree/main/charts/library/common/values.yaml) for
...
application. For more deployment examples, check out the [`examples` folder](https://github.com/ntrp/helm-charts/tree/main/examples/).
...
[here](https://github.com/ntrp/helm-charts/tree/main/charts/other/app-template).
